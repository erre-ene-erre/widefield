...
<script>
  window.SnipcartSettings = {
    ...
    modalStyle: "side",
    currency: "chf",
    templatesUrl: "/site/templates/snipcart/snipcart-templates.html",
  };
  ...
  document.addEventListener('snipcart.ready', () => {
    const checkoutButton = document.querySelector('.snipcart-checkout-box');
    ...
    Snipcart.store.subscribe(() => { updateCheckoutButtonVisibility();});
            ...
            // const checkoutButton = document.querySelector('.snipcart-checkout');
